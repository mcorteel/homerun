            ...
            <div class=\"modal-dialog\">
                <div class=\"modal-content\">
                    ...
                    <div class=\"modal-body\">
                        <ul class=\"icons\">";
        $icons = Array("bullhorn", "shopping-cart", "music", "file-text-o", "anchor", "archive", "arrows", "asterisk", "ban", "bar-chart-o", "barcode", "beer", "bell-o", "bolt", "book", "briefcase", "bug", "building-o", "calendar", "camera", "clock-o", "cloud", "coffee", "compass", "credit-card", "cutlery", "dashboard", "desktop", "envelope-o", "film", "flag", "flask", "gamepad", "gavel", "gift", "glass", "globe", "headphones", "heart", "home", "key", "laptop", "leaf", "lightbulb-o", "magic", "magnet", "microphone", "moon-o", "pencil", "phone", "plane", "print", "puzzle-piece", "road", "rocket", "suitcase", "tags", "tint", "trophy", "truck", "umbrella", "video-camera", "wrench", "bicycle", "bus", "calculator", "soccer-ball-o", "paint-brush", "newspaper-o", "bed", "diamond", "heartbeat", "motorcycle", "ship", "street-view", "subway", "train", "user-secret", "child", "male", "female");
        sort($icons);
